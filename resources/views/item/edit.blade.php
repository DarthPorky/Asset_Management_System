<x-layout>
    <h1>Edit {{$asset->name}} Asset</h1>
    <form class="row g-3" enctype="multipart/form-data" method="POST" action="/assets/{{$asset->id}}">
        @csrf
        @method('PUT')
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <select class="form-select" name="depriciation_type" id="">
                <option value="{{$asset->depriciation_type}}" selected>-- {{$asset->depriciation_type}} --</option>
